...
export class ProductosProvider {
  ...
  public initDB(): void {
    ...
    const oldDB: PouchDB.Database = new PouchDB("producto_1", {revs_limit: 5, auto_compaction: true});
    oldDB.destroy();
    /*********************************** */

    this._db = new PouchDB("producto_2", {revs_limit: 5, auto_compaction: true});
